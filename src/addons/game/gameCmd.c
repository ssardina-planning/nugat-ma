...
/* Commands specific to game. */
										...
										static int UsageCheckAtlReachTargetSpec ARGS((OStream_ptr errostream));                                        
...
static int UsageGameCheckProperty(OStream_ptr errostream)
{
    ...
    OStream_printf(errostream, "  -b \t\t Checks ATLREACHTARGET properties.\n");
...
static int UsageGameShowProperty(OStream_ptr errostream)
{
    ...
    OStream_printf(errostream, "  -b \t\tPrints only ATLREACHTARGET properties.\n");
...
static int UsageCheckAtlReachTargetSpec(OStream_ptr errostream)
{
    OStream_printf(errostream,
            "usage: check_reach_target [-h] [-m | -o output-file] "
                    "[-n number]\n"
